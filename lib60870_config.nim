...
##  lib60870_config.h
##
##  Включать ли поддержку протокола 101
##  #define CONFIG_CS101_USE
##
...
const
  CONFIG_CS104_SLAVE_POOL_SIZE* = 1
...
const
  CONFIG_CS104_MESSAGE_QUEUE_POOL_SIZE* = 1
...
const
  CONFIG_SLAVE_USE_SEPARATE_CALLBACK_THREAD* = 0
...
const
  CONFIG_SLAVE_SEPARATE_CALLBACK_THREAD_QUEUE_SIZE* = 12
...
const
  CONFIG_ACTIVATE_TCP_KEEPALIVE* = 0
